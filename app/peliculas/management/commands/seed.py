...
SAMPLE = [
    ...
    ("Comedia", [
        ...
        ("La Gran Broma", "Comedia de situaciones.", 2018),
    ]),
    ("Drama", [
        ("En Silencio", "Historia emotiva sobre la superacion.", 2020),
        ("El Camino", "Drama familiar y personal.", 2012),
    ]),
]


class Command(BaseCommand):
    help = 'Crea datos de ejemplo (generos y peliculas) para peliculas'
